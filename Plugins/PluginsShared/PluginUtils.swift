...
func deriveProtocPath(using config: CommonConfiguration, tool findTool: (String) throws -> PackagePlugin.PluginContext.Tool) throws -> URL {
...
func deriveOutputFilePath(for inputFile: URL, using fileNaming: CommonConfiguration.FileNaming, protoDirectoryPath: URL, outputDirectory: URL, outputExtension: String) -> URL {
